...
class Trip:
    all_cities = (
        'Arak', 'Ardabil', 'Urmia', 'Isfahan', 'Ahvaz', 'Ilam', 'Bojnord', 'Bandar Abbas', 'Bushehr', 'Birjand', 'Tabriz', 'Tehran', 'Khorramabad',
        'Rasht', 'Zahedan', 'Zanjan', 'Sari', 'Semnan', 'Sanandaj', 'Shahr-e Kord', 'Shiraz', 'Qazvin', 'Qom', 'Karaj', 'Kermanshah', 'Gorgan',
        'Mashhad',
        'Hamadan', 'Yasuj', 'Yazd')
    ...
    def __call__(self, *args, **kwargs):
        ...
        for passenger in self.passengers:
            sum_load_weight += passenger.load_weight
        return self.train.weight_capacity - sum_load_weight
